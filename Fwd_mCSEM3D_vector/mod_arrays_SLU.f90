...
!if( modeling == 'Poisson' .or. modeling == 'MT_TE' )then
!  do i=1, nglob

!    if( int(matcoord(i,4)) == 1 )then
!      do k=1, ngl
!        do j=col_ptr(ngl*i-(k-1)), col_ptr(ngl*i-(k-1)+1)-1
!          if( row_ind(j) == ngl*i-(k-1) )then
!            val_nz(j) = 1.d30
!          end if
!          vfonte(ngl*i-(k-1))=0.d0
!        end do
!      end do
!
!  !   if( i > 1 .or. i < nglob )then
!  !     do j=col_ptr(i)-1, 1, -1
!  !       if( row_ind(j) == i )then
!  !         val_nz(j) = 0.d0
!  !       end if
!  !     end do
!  !
!  !     do j=col_ptr(i+1), col_ptr(nglob+1)-1
!  !       if( row_ind(j) == i )then
!  !         val_nz(j) = 0.d0
!  !       end if
!  !     end do
...
!  !   else if( i == 1 )then
!  !
!  !     do j=col_ptr(2), col_ptr(nglob+1)-1
!  !       if( row_ind(j) == i )then
!  !         val_nz(j) = 0.d0
!  !       end if
!  !       end do
!  !
!  !   else if( i == nglob )then
!  !
!  !     do j=col_ptr(i)-1, 1, -1
!  !       if( row_ind(j) == i )then
!  !         val_nz(j) = 0.d0
...
!    end if
!  end do
!else if( modeling == 'MT_TM' )then
!  do i=1, nglob
!
!    if( int(matcoord(i,4)) == 1 .or. int(matcoord(i,4)) == 23)then
!      do k=1, ngl
!        do j=col_ptr(ngl*i-(k-1)), col_ptr(ngl*i-(k-1)+1)-1
!          if( row_ind(j) == ngl*i-(k-1) )then
!            val_nz(j) = 1.d30
